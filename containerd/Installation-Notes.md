...
vijay@Azure:~$ cd super-k8s-Learning/containerd
vijay@Azure:~/super-k8s-Learning/containerd$ ls
...
vijay@Azure:~/super-k8s-Learning/containerd$ code .
vijay@Azure:~/super-k8s-Learning/containerd$ # Execute commands in containerd-deploy-vm.sh
vijay@Azure:~/super-k8s-Learning/containerd$ # set env variables
vijay@Azure:~/super-k8s-Learning/containerd$ resourceGroupName="containerd-rg"
vijay@Azure:~/super-k8s-Learning/containerd$ location="centralindia"
vijay@Azure:~/super-k8s-Learning/containerd$ deploymentName="containerdvm-deploy"
vijay@Azure:~/super-k8s-Learning/containerd$ # download template
vijay@Azure:~/super-k8s-Learning/containerd$ wget https://raw.githubusercontent.com/vijayraavi/super-k8s-Learning/main/containerd/containerd-single-node.json -O template.json
--2021-05-30 15:01:35--  https://raw.githubusercontent.com/vijayraavi/super-k8s-Learning/main/containerd/containerd-single-node.json
...
vijay@Azure:~/super-k8s-Learning/containerd$
vijay@Azure:~/super-k8s-Learning/containerd$ # create resource group
vijay@Azure:~/super-k8s-Learning/containerd$ az group create -n $resourceGroupName -l $location
{
  "id": "/subscriptions/46acb3e9-3ccf-4a40-a682-22eb0c76bc91/resourceGroups/containerd-rg",
...
vijay@Azure:~/super-k8s-Learning/containerd$
vijay@Azure:~/super-k8s-Learning/containerd$ # deploy the vms
vijay@Azure:~/super-k8s-Learning/containerd$ az deployment group create \
> -g $resourceGroupName \
> -n $deploymentName \
> --template-file template.json
{
  "id": "/subscriptions/46acb3e9-3ccf-4a40-a682-22eb0c76bc91/resourceGroups/containerd-rg/providers/Microsoft.Resources/deployments/containerdvm-deploy",
  "location": null,
