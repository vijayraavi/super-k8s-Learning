...
sudo wget -O /home/azureuser/k8s-initialize-cluster.sh https://raw.githubusercontent.com/vijayraavi/super-k8s-Learning/main/My-K8S-Works/6-Expose-svc-K8S/k8s-initialize-cluster.sh