...
wget https://raw.githubusercontent.com/vijayraavi/super-k8s-Learning/main/My-K8S-Works/5-Sidecar-Container-Logs/sidecare-arm-deploy.json -O template.json
...
# download the yml
wget https://raw.githubusercontent.com/vijayraavi/super-k8s-Learning/main/My-K8S-Works/5-Sidecar-Container-Logs/sidecar-pod.yml
